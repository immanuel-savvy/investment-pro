let ADMINSTRATORS,ADMIN_HASH,GLOBALS,USERS,USERS_HASH,GLOBAL_alumni_overview,GLOBALS_about_statement,GLOBALS_mission_statement,GLOBALS_vision_statement,GLOBAL_logo;_738‍.x([["create_default_admin",()=>create_default_admin],["default_user",()=>default_user]]);_738‍.w("../ds/conn",[["ADMINSTRATORS",["ADMINSTRATORS"],function(v){ADMINSTRATORS=v}],["ADMIN_HASH",["ADMIN_HASH"],function(v){ADMIN_HASH=v}],["GLOBALS",["GLOBALS"],function(v){GLOBALS=v}],["USERS",["USERS"],function(v){USERS=v}],["USERS_HASH",["USERS_HASH"],function(v){USERS_HASH=v}]]);_738‍.w("./reviews",[["GLOBAL_alumni_overview",["GLOBAL_alumni_overview"],function(v){GLOBAL_alumni_overview=v}]]);_738‍.w("./settings",[["GLOBALS_about_statement",["GLOBALS_about_statement"],function(v){GLOBALS_about_statement=v}],["GLOBALS_mission_statement",["GLOBALS_mission_statement"],function(v){GLOBALS_mission_statement=v}],["GLOBALS_vision_statement",["GLOBALS_vision_statement"],function(v){GLOBALS_vision_statement=v}],["GLOBAL_logo",["GLOBAL_logo"],function(v){GLOBAL_logo=v}]]);
